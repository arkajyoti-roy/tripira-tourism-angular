...
export class Food {
  foodItems = [
    ...
    { 
      // name: 'Kosoi Bwtwi', 
      image: '/about/food/Kosoi bwtwi.png',
    ...
    { 
      // name: 'Mosdeng Serma', 
      image: '/about/food/mosdeng serma.png',
    ...
    { 
      // name: 'Wak BAHAN', 
      image: '/about/food/WAK BAHAN.png',
